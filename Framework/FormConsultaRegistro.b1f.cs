...
namespace FRMTransportePassageiros.Framework
{
    ...
    public class FormConsultaRegistro : UserFormBase
    {
        ...
        public void MontaMatrizConsulta()
        {
            try
            {
                this.UIAPIRawForm.DataSources.DataTables.Item("dtCons1").ExecuteQuery(this.query);

                mtxConsulta.Columns.Item("cCodCon").DataBind.Bind("dtCons1", "Code");
                mtxConsulta.Columns.Item("cNameCon").DataBind.Bind("dtCons1", "Name");
